...
map.getView().fit([-8369690.043471, 1145285.654631, -8369275.524666, 1145522.460532], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAHATES_ESTE_si (QFieldCloud)</h2>';
        return titleElement;
    })(),
